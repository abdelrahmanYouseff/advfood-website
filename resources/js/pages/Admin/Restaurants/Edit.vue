    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
          ...
          <p class="mt-1 text-sm text-gray-500">تعديل معلومات المطعم: {{ restaurant.name }}</p>
        </div>
        ...
        <form @submit.prevent="submit" enctype="multipart/form-data" class="p-6 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div v-if="restaurant.logo_url" class="w-32 h-32 rounded-lg overflow-hidden border border-gray-200">
                <img :src="restaurant.logo_url" :alt="restaurant.name + ' شعار'" class="w-full h-full object-cover" />
              </div>
            ...
            <div>
              ...
              <div v-if="restaurant.cover_image_url" class="w-32 h-32 rounded-lg overflow-hidden border border-gray-200">
                <img :src="restaurant.cover_image_url" :alt="restaurant.name + ' غلاف'" class="w-full h-full object-cover" />
              </div>
              <div v-else class="w-32 h-32 bg-gray-100 rounded-lg flex items-center justify-center">
                <span class="text-gray-400 text-sm">لا توجد صورة غلاف</span>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label for="logo" class="block text-sm font-medium text-gray-700 mb-2">شعار جديد (اختياري)</label>
            ...
            <div>
              <label for="cover_image" class="block text-sm font-medium text-gray-700 mb-2">صورة غلاف جديدة (اختياري)</label>
              <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-green-400 transition-colors duration-200">
                <div class="space-y-1 text-center">
                  <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
